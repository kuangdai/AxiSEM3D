...
# use fftw "lucky" numbers or not [bool]
...
# basic reference value [integer]
NU_EMP_REF                                  24

# global minimum value [integer]
NU_EMP_MIN                                  8

# scale NU_EMP_REF by s-coordinate, i.e., distance to axis
# Fs = (s / R0) ^ NU_EMP_POW_AXIS
# on-off [bool] and parameters [real]
...
# If set true, AxiSEM3D will try to learn a Wisdom in the next simulation [bool]
...
# interval of Wisdom learning  [integer]
NU_WISDOM_LEARN_INTERVAL                    100 

# file to save the learned Wisdom [string]
NU_WISDOM_LEARN_OUTPUT                      name.nu_wisdom

# Wisdom that will be used in the next simulation [string] 
NU_WISDOM_REUSE_INPUT                       name.nu_wisdom

# factor multiplied to Nu(s, z) specified in NU_WISDOM_REUSE_INPUT [real]
