...
public:    
    ...
    // int
    void readMetaData(const std::string &vname, IColX &data, std::vector<size_t> &dims) const;
    void read1D(const std::string &vname, IColX &data) const;
    void read2D(const std::string &vname, IMatXX &data) const;
